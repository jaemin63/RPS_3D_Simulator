    ...
    (h
      ...
      : n !== k &&
        (void 0 === $jscomp.propertyToPolyfillSymbol[l] &&
          ((k = (1e9 * Math.random()) >>> 0),
          ($jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(l) : $jscomp.POLYFILL_PREFIX + k + "$" + l)),
        $jscomp.defineProperty(p, $jscomp.propertyToPolyfillSymbol[l], { configurable: !0, writable: !0, value: n })));
};
$jscomp.polyfill(
  "Promise",
  function (h) {
...
var DracoDecoderModule = (function () {
  ...
  return function (n) {
    ...
    if (Ua) {
      ...
      fa ? (U = self.location.href) : "undefined" != typeof document && document.currentScript && (U = document.currentScript.src),
        h && (U = h),
